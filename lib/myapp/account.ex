defmodule MyApp.Account do
  alias MyApp.Account.{User, UserLib, UserQueries}
  ...
  @doc section: :user
  @spec get_user(MyApp.user_id()) :: User.t() | nil
  ...
  # UserTokens
  alias MyApp.Account.{UserToken, UserTokenLib, UserTokenQueries}

  @doc false
  @spec user_token_query(MyApp.query_args()) :: Ecto.Query.t()
  defdelegate user_token_query(args), to: UserTokenQueries

  @doc section: :user_token
  @spec list_user_tokens(MyApp.query_args()) :: [UserToken.t()]
  defdelegate list_user_tokens(args), to: UserTokenLib

  @doc section: :user_token
  @spec get_user_token!(UserToken.id()) :: UserToken.t()
  @spec get_user_token!(UserToken.id(), MyApp.query_args()) :: UserToken.t()
  defdelegate get_user_token!(user_token_id, query_args \\ []), to: UserTokenLib

  @doc section: :user_token
  @spec get_user_token(UserToken.id()) :: UserToken.t() | nil
  @spec get_user_token(UserToken.id(), MyApp.query_args()) :: UserToken.t() | nil
  defdelegate get_user_token(user_token_id, query_args \\ []), to: UserTokenLib
  ...
  @doc section: :user_token
  @spec create_user_token(MyApp.user_id(), String.t(), String.t(), String.t()) ::
