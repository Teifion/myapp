defmodule MyApp.Account.UserTokenLib do
  @moduledoc """
  Library of UserToken related functions.
  """
  alias MyApp.Repo
  alias MyApp.Account.{UserToken, UserTokenQueries}
  ...
  def delete_user_token(%UserToken{} = user_token) do
    MyApp.invalidate_cache(:user_token_identifier_cache, user_token.identifier_code)
  ...
  @spec delete_user_tokens(MyApp.user_id()) :: :ok
