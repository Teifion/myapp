defmodule MyAppWeb.BootstrapComponents do
  @moduledoc false
  ...
  @doc """
  <MyAppWeb.BootstrapComponents.dropdown items={@items} />
  """
  ...
  @doc """
  <MyAppWeb.BootstrapComponents.dropdown unit={@unit} limit={@limit} display_mode={@display_mode} />
  ...
  @doc """
  <MyAppWeb.BootstrapComponents.card>
    CONTENT
  </MyAppWeb.BootstrapComponents.card>
  """
  slot :inner_block, required: true
  ...
  <MyAppWeb.BootstrapComponents.pill>
    CONTENT
  </MyAppWeb.BootstrapComponents.pill>
  """
  slot :inner_block, required: true
