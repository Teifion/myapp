defmodule MyAppWeb.UserAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_MyApp_user_remember_me"
  ...
  def log_in_with_token(conn, %MyApp.Account.UserToken{} = token, params \\ %{}) do
    user_return_to = get_session(conn, :user_return_to)
  ...
  def log_out_user(conn) do
    ...
    cached_user_token && MyApp.invalidate_cache(:user_token_identifier_cache, cached_user_token.identifier_code)
