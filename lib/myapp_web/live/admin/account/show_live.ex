defmodule MyAppWeb.Admin.Account.ShowLive do
  @moduledoc false
  ...
  def handle_info(
        {MyAppWeb.Account.UserFormComponent, {:updated_changeset, %{changes: _changes}}},
        socket
      ) do
    {:noreply, socket}
  end
  ...
  def handle_event("delete-user-token", %{"token_id" => token_id}, socket) do
    token = MyApp.Account.get_user_token(token_id)
    MyApp.Account.delete_user_token(token)
